...
export const footerData: FooterData = {
  companyInfo: {
    name: "JobPortal",
    description: "Platform terpercaya untuk menemukan pekerjaan impian dan menghubungkan talent terbaik dengan perusahaan berkualitas.",
  ...
  sections: [
    ...
    },
    {
      ...
      links: [
        ...
        {
          name: "Panduan Rekrutmen",
          href: "/recruitment-guide"
        }
      ]
    },
    {
  ...
  socialLinks: [
    ...
    {
      name: "YouTube",
      href: "https://youtube.com/jobportal",
      icon: Youtube
    }
  ],
