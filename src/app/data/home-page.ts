...
export const homePageData: HomePageData = {
  heroSection: {
    ...
    description:
      "Platform terpercaya untuk menemukan pekerjaan terbaik dari perusahaan ternama di seluruh Indonesia",
    stats: {
      totalJobs: 15420,
  ...
  jobCategories: [
    { id: "technology", name: "Teknologi & IT", icon: Code, count: 3245, trending: true },
    { id: "design", name: "Desain & Kreatif", icon: Palette, count: 1876 },
    { id: "marketing", name: "Marketing & Sales", icon: TrendingUp, count: 2134, trending: true },
    { id: "healthcare", name: "Kesehatan", icon: Heart, count: 987 },
    { id: "business", name: "Bisnis & Manajemen", icon: Briefcase, count: 1654 },
    { id: "frontend", name: "Frontend Developer", icon: Monitor, count: 892 },
    { id: "backend", name: "Backend Developer", icon: Server, count: 756, trending: true },
    { id: "mobile", name: "Mobile Developer", icon: Smartphone, count: 623 },
  ],
